        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty(Auth::user()->photo) ? asset('upload/sekolah-image/' . Auth::user()->photo) : asset('upload/no_image.jpg') }}" class="user-img"
                        alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('sekolah.profile') }}"><i
                    ...
                    <li><a class="dropdown-item" href="{{ route('sekolah.logout') }}"><i
