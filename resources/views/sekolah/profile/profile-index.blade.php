@extends('sekolah.sekolah-dashboard')
                ...
                <div class="row">
                    <div class="col-lg-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ !empty($getUser->photo) ? asset('upload/sekolah-image/' . $getUser->photo) : asset('upload/no_image.jpg') }}"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('sekolah.profile.updatePassword') }}" method="POST"
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('sekolah.profile.update') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Telp/HP Sekolah</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="date" id="join" name="join" class="form-control"
                                                value="{{ $getUser->sekolah_join_date }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Deskripsi Sekolah</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" name="info">{{ $getUser->sekolah_info }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Photo Sekolah</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showPhoto"
                                                src="{{ !empty($getUser->photo) ? asset('upload/sekolah-image/' . $getUser->photo) : asset('upload/no_image.jpg') }}"
